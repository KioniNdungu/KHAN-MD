const {
  ...
  const ownerNumber = ['254701894950']
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet Air. WhatsApp Bot.\n\n *Thanks for using KHAN-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029VatOy2EAzNc2WcShQw1j\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/XdTechPro/KHAN-MD\n\n> © Powered BY JawadTechX \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/ayfex5.png` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('254701894950', '254707715807');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("'254701894950', '254707715807'")){
  if(isReact) return
  m.react("🦋")
   }
  //==========public react============//
